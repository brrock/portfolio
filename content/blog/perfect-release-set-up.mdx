...
Then make a config file for it, .github/release-please-config.json

{
  "changelog-type": "github"
}

This file is to ensure changlelogs are made in the github style. The release yml file basically runs release and if it releases, it will then add credits to the contributors who made the commit. It updates the changelog and the release. There also is a danger config, .github/workflows/