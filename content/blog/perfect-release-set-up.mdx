...
This file is to ensure changlelogs are made in the github style. The release yml file basically runs release and if it releases, it will then add credits to the contributors who made 