...
AI can generate text, images, audio and even video. But they have **zero** intergration with other tools. This is where MCP comes in, send emails, edit files, deep research, orangise folders and look up docs are just a few examples. I really enjoy having that intregation espically via so